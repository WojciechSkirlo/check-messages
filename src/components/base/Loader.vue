    ...
    <div class="flex flex-col items-center mb-12">
      ...
      >
        <div class="flex items-center justify-center bg-black rounded-full w-36 h-36 bg-opacity-10">
          ...
          >
            <svg v-if="isLoaded" class="fill-white" xmlns="http://www.w3.org/2000/svg" width="43" height="34" viewBox="0 0 43 34" fill="none">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
      ...
      <div class="flex flex-col items-center">
        <h3
          ...
          v-text="isLoaded ? 'we succeeded!' : 'loading... (it may take some time)'"
        ></h3>
      </div>
      <Transition name="fade">
        <BaseButton v-if="isLoaded" @click="$emit('checkResults')">Check the results 💬</BaseButton>
      </Transition>
    </div>
