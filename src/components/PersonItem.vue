<template>
  <div
    class="flex items-center w-full px-6 py-4 transition-colors duration-300 gap-x-6 hover:bg-gray-50"
  >
    ...
    <div class="flex flex-col w-[calc(100%-70px)]">
      <div class="flex items-center justify-between w-full gap-x-5">
        <h3 class="min-w-0 font-medium truncate" :title="decodeText(item.name)">
      ...
      <div
        class="self-start px-5 py-1 mt-3 text-sm border border-gray-100 rounded-full"
      >
